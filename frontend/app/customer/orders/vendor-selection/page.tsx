...
function ChatMessage({ role, text }: { role: Message["role"]; text: string }) {
...
function AssistantPanel({ messages, isTyping, input, setInput, onSend, scrollRef }: AssistantPanelProps) {
